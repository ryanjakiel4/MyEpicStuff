...
import java.io.*;
public class Awesome extends Canvas
implements KeyListener
{
   ...
   public Awesome(Dimension size)
   {
      ...
      System.out.println("Size of playing grid?");
      System.out.println("Horizontal size?");
      cols = Integer.parseInt(scanny.nextLine());
      System.out.println("Vertical size?");
      rows = Integer.parseInt(scanny.nextLine());
      ...
      players = Integer.parseInt(scanny.nextLine());
      for(int p = 0; p < players; p++)
         System.out.println(playerControls[p]); 
      System.out.println("Speed? (Normal Game: 10)");
      speedOfPlay = Integer.parseInt(scanny.nextLine());
      System.out.println("How Long? (minutes)");
      gameTime = Double.parseDouble(scanny.nextLine());
      gameLength = (int)(gameTime*360);
      scanny.close();
      if(players == 2)
      {
         player1Row = rows/3;
   ...
   public void Draw()
   {
      ...
      if(countdown)
      {
         ...
         if(generalCount < 50)
            ...
            bufferGraphics.drawString("GO", WINDOWWIDTH/3,WINDOWHEIGHT*3/4);
      }
