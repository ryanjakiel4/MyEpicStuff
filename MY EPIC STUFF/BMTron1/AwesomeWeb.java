...
import java.io.*;
public class AwesomeWeb extends Canvas
implements KeyListener
{
   ...
   public AwesomeWeb(Dimension size)
   {
   ...
   public void Draw()
   {
      ...
      //draw grid lines
         ...
         if(players == 2)
         {
            bufferGraphics.drawString("Squares--Player 1: " + player1Squares + "      Player 2: " + player2Squares, 10, REALWINDOWHEIGHT - 30); 
            bufferGraphics.drawString("Wins--Player 1: " + player1Wins + "      Player 2: " + player2Wins, WINDOWWIDTH/2, REALWINDOWHEIGHT - 30); 
         }
         else if(players == 3)
         {
            bufferGraphics.drawString("Squares--Player 1: " + player1Squares + "      Player 2: " + player2Squares + "      Player 3: " + player3Squares, 10, REALWINDOWHEIGHT - 30);
            bufferGraphics.drawString("Wins--Player 1: " + player1Wins + "      Player 2: " + player2Wins + "      Player 3: " + player3Wins, WINDOWWIDTH/2, REALWINDOWHEIGHT - 30);
         }
         else if(players == 4)
         {
            bufferGraphics.drawString("Squares--Player 1: " + player1Squares + "      Player 2: " + player2Squares + "      Player 3: " + player3Squares + "      Player 4: " + player4Squares, 10, REALWINDOWHEIGHT - 30);
            bufferGraphics.drawString("Wins--Player 1: " + player1Wins + "      Player 2: " + player2Wins + "      Player 3: " + player3Wins + "      Player 4: " + player4Wins, WINDOWWIDTH*7/16, REALWINDOWHEIGHT - 30);
         }
         bufferGraphics.drawString("Time: " + (gameLength*100 - gameLengthSoFar)/speedOfPlay, WINDOWWIDTH-200, REALWINDOWHEIGHT - 30);
      }
      Graphics2D bufferGraphics2D = (Graphics2D)bufferGraphics;
