...
implements KeyListener, Runnable
{
   ...
   private int[] heroJumpList = new int[]{-9,-9,-9,-8,-8,-8,-8,-7,-7,-7,-7,-7,-6,-6,-6,-6,-6,-5,-5,-5,-5,-5,-4,-4,-4,-4,-4,-4,-3,-3,-3,-3,-3,-3,-3};
   ...
   private String[][] message = new String[][]{{"You found the Sword! Press Z", "to use it and slash any enemy","that you find in your way.","You'll even gain some","rupees to boost your score."},{"Obtained bow and arrows! Press","X to kill enemies from a distance!","Be careful, you only have a","limited amount of arrows and", "it takes time to shoot arrows."}};
   ...
   public NewGameEndlessMatthew(Dimension size)
   {
      ...
      //try
      //{
      //File file = new File("C:/Users/wicke_000/Documents/MY EPIC STUFF/NewGame/WreckItRalph.mp3");
         ...
         if(introduction)
         {
            ...
            if(gameover)
            {
               ...
               else
               {
                  ...
                  heroY = 440;
                  if(score >= 300  && onlyOnce2)
                  {
                     try
                     {
                        PrintWriter printy = new PrintWriter(new File("YO_MATTHEW_OPEN_THIS.txt"));
                        printy.println("Checked your room recently?");
                        printy.close();
                        onlyOnce2 = false;
                     }
            ...
            if(indexOfCollision == -1)
            {
               ...
               if(arrowShot)
               {
                  ...
                  else
                  {
                     for(int n = 0; n < likeArray.size(); n++)
                     {
                        if(Math.abs(arrowX - (likeArray.get(n).getX() + 20)) <= arrowSpeed && Math.abs(likeArray.get(n).getY()-arrowY) < 50)
                        {
                           likeArray.remove(n);
                           r = Math.random()*level;
                           if(r > 5)
   ...
   public void Draw()
   {
      ...
      else
      {
         try
         {
            ...
            if(displayStars && (Math.abs(backgroundImagePlace%(endlessBackground1.getHeight() + WINDOWHEIGHT) - endlessBackground1.getHeight()) >= WINDOWHEIGHT-platformSpeed))
               endlessBackground1 = starBackground;
            if(displayStars && (Math.abs((backgroundImagePlace+endlessBackground2.getHeight())%(endlessBackground2.getHeight() + WINDOWHEIGHT) - endlessBackground2.getHeight()) >= WINDOWHEIGHT-platformSpeed))
            ...
            */
            ...
            if(gameover)
            {
               if(backgroundImagePlace == 0)
               {
                  ...
                  if(onlyOnce)
                  {
                     ...
                     //System.out.println(high[0] + " " + high[1] + " " + high[2] + " " + high[3] + " " + high[4] + " " + high[5] + " " + high[6] + " " + high[7] + " " +high[8]);
                     in.close();
                     zipFile.close();
            ...
            if(hasQuiver)
            {
               ...
               if(numberOfArrows == 10)
                  bufferGraphics.drawString("'s:MAX " + numberOfArrows,435,17);
               else 
   ...
   {
      //brandNewImage = (Graphics2D)(bufferStrategy.getDrawGraphics()).getDeviceConfiguration().createCompatibleImage(d.width,h.height);
   ...
   {
      try {
         heroImageLeft[1] = ImageIO.read((getClass().getResourceAsStream("moveLeft1.png")));
         heroImageLeft[2] = ImageIO.read((getClass().getResourceAsStream("moveLeft2.png")));
         heroImageLeft[3] = ImageIO.read((getClass().getResourceAsStream("moveLeft3.png")));
         heroImageLeft[4] = ImageIO.read((getClass().getResourceAsStream("moveLeft4.png")));
         heroImageLeft[5] = ImageIO.read((getClass().getResourceAsStream("moveLeft5.png")));
         heroImageLeft[6] = ImageIO.read((getClass().getResourceAsStream("moveLeft6.png")));
         heroImageLeft[7] = ImageIO.read((getClass().getResourceAsStream("moveLeft7.png")));
         heroImageLeft[8] = ImageIO.read((getClass().getResourceAsStream("moveLeft8.png")));
         heroImageLeft[9] = ImageIO.read((getClass().getResourceAsStream("moveLeft9.png")));
         heroImageLeft[0] = ImageIO.read((getClass().getResourceAsStream("moveLeft0.png")));
         heroImageLeft[10] = ImageIO.read((getClass().getResourceAsStream("moveLeft10.png")));
         heroImageRight[1] = ImageIO.read((getClass().getResourceAsStream("moveRight1.png")));
         heroImageRight[2] = ImageIO.read((getClass().getResourceAsStream("moveRight2.png")));
         heroImageRight[3] = ImageIO.read((getClass().getResourceAsStream("moveRight3.png")));
         heroImageRight[4] = ImageIO.read((getClass().getResourceAsStream("moveRight4.png")));
         heroImageRight[5] = ImageIO.read((getClass().getResourceAsStream("moveRight5.png")));
         heroImageRight[6] = ImageIO.read((getClass().getResourceAsStream("moveRight6.png")));
         heroImageRight[7] = ImageIO.read((getClass().getResourceAsStream("moveRight7.png")));
         heroImageRight[8] = ImageIO.read((getClass().getResourceAsStream("moveRight8.png")));
         heroImageRight[9] = ImageIO.read((getClass().getResourceAsStream("moveRight9.png")));
         heroImageRight[0] = ImageIO.read((getClass().getResourceAsStream("moveRight0.png")));
         heroImageRight[10] = ImageIO.read((getClass().getResourceAsStream("moveRight10.png")));
         swordLeft[0] = ImageIO.read((getClass().getResourceAsStream("swordLeft0.png")));
         swordLeft[1] = ImageIO.read((getClass().getResourceAsStream("swordLeft1.png")));
         swordLeft[2] = ImageIO.read((getClass().getResourceAsStream("swordLeft2.png")));
         swordLeft[3] = ImageIO.read((getClass().getResourceAsStream("swordLeft3.png")));
         swordLeft[4] = ImageIO.read((getClass().getResourceAsStream("swordLeft4.png")));
         swordLeft[5] = ImageIO.read((getClass().getResourceAsStream("swordLeft5.png")));
         swordLeft[6] = ImageIO.read((getClass().getResourceAsStream("swordLeft6.png")));
         swordLeft[7] = ImageIO.read((getClass().getResourceAsStream("swordLeft7.png")));
         swordRight[0] = ImageIO.read((getClass().getResourceAsStream("swordRight0.png")));
         swordRight[1] = ImageIO.read((getClass().getResourceAsStream("swordRight1.png")));
         swordRight[2] = ImageIO.read((getClass().getResourceAsStream("swordRight2.png")));
         swordRight[3] = ImageIO.read((getClass().getResourceAsStream("swordRight3.png")));
         swordRight[4] = ImageIO.read((getClass().getResourceAsStream("swordRight4.png")));
         swordRight[5] = ImageIO.read((getClass().getResourceAsStream("swordRight5.png")));
         swordRight[6] = ImageIO.read((getClass().getResourceAsStream("swordRight6.png")));
         swordRight[7] = ImageIO.read((getClass().getResourceAsStream("swordRight7.png")));
         sword = ImageIO.read((getClass().getResourceAsStream("sword.png")));
      ...
      //    
         beginningBackground = ImageIO.read((getClass().getResourceAsStream("beginningBackground1.png")));
         endlessBackground = ImageIO.read((getClass().getResourceAsStream("endlessBackground1.png")));
         endlessBackground1 = ImageIO.read((getClass().getResourceAsStream("endlessBackground1.png")));
         endlessBackground2 = ImageIO.read((getClass().getResourceAsStream("endlessBackground1.png")));
         hearts[0] = ImageIO.read((getClass().getResourceAsStream("0Hearts.png")));
         hearts[1] = ImageIO.read((getClass().getResourceAsStream("1Hearts.png")));
         hearts[2] = ImageIO.read((getClass().getResourceAsStream("2Hearts.png")));
         hearts[3] = ImageIO.read((getClass().getResourceAsStream("3Hearts.png")));
         linkDead[0] = ImageIO.read((getClass().getResourceAsStream("linkDead1.png")));
         linkDead[1] = ImageIO.read((getClass().getResourceAsStream("linkDead2.png")));
         linkDead[2] = ImageIO.read((getClass().getResourceAsStream("linkDead3.png")));
         linkDead[3] = ImageIO.read((getClass().getResourceAsStream("linkDead4.png")));
         linkDead[4] = ImageIO.read((getClass().getResourceAsStream("linkDead5.png")));
         linkDead[5] = ImageIO.read((getClass().getResourceAsStream("linkDead6.png")));
         linkDead[6] = ImageIO.read((getClass().getResourceAsStream("linkDead7.png")));
         linkDead[7] = ImageIO.read((getClass().getResourceAsStream("linkDead8.png")));
         linkDead[8] = ImageIO.read((getClass().getResourceAsStream("linkDead9.png")));
         linkDead[9] = ImageIO.read((getClass().getResourceAsStream("linkDead10.png")));
         linkDead[10] = ImageIO.read((getClass().getResourceAsStream("linkDead11.png")));
         linkDead[11] = ImageIO.read((getClass().getResourceAsStream("linkDead12.png")));
         linkDead[12] = ImageIO.read((getClass().getResourceAsStream("linkDead13.png")));
         arrowRight = ImageIO.read((getClass().getResourceAsStream("arrowRight.png")));
         arrowLeft = ImageIO.read((getClass().getResourceAsStream("arrowLeft.png")));
         gameOver = ImageIO.read((getClass().getResourceAsStream("gameover.png")));
         pressZ = ImageIO.read((getClass().getResourceAsStream("pressZ.png")));
         quiver = ImageIO.read((getClass().getResourceAsStream("quiver.png")));
         shootArrowRight[1] = ImageIO.read((getClass().getResourceAsStream("shootArrowRight1.png")));
         shootArrowRight[2] = ImageIO.read((getClass().getResourceAsStream("shootArrowRight2.png")));
         shootArrowRight[3] = ImageIO.read((getClass().getResourceAsStream("shootArrowRight3.png")));
         shootArrowRight[4] = ImageIO.read((getClass().getResourceAsStream("shootArrowRight4.png")));
         shootArrowRight[5] = ImageIO.read((getClass().getResourceAsStream("shootArrowRight5.png")));
         shootArrowRight[6] = ImageIO.read((getClass().getResourceAsStream("shootArrowRight6.png")));
         shootArrowRight[7] = ImageIO.read((getClass().getResourceAsStream("shootArrowRight7.png")));
         shootArrowRight[8] = ImageIO.read((getClass().getResourceAsStream("shootArrowRight8.png")));
         shootArrowRight[9] = ImageIO.read((getClass().getResourceAsStream("shootArrowRight9.png")));
         shootArrowRight[10] = ImageIO.read((getClass().getResourceAsStream("shootArrowRight10.png")));
         shootArrowRight[11] = ImageIO.read((getClass().getResourceAsStream("shootArrowRight11.png")));
         shootArrowRight[12] = ImageIO.read((getClass().getResourceAsStream("shootArrowRight12.png")));
         shootArrowRight[13] = ImageIO.read((getClass().getResourceAsStream("shootArrowRight13.png")));
         shootArrowRight[14] = ImageIO.read((getClass().getResourceAsStream("shootArrowRight14.png")));
         shootArrowRight[15] = ImageIO.read((getClass().getResourceAsStream("shootArrowRight15.png")));
         shootArrowRight[0] = ImageIO.read((getClass().getResourceAsStream("shootArrowRight0.png")));
         shootArrowLeft[1] = ImageIO.read((getClass().getResourceAsStream("shootArrowLeft1.png")));
         shootArrowLeft[2] = ImageIO.read((getClass().getResourceAsStream("shootArrowLeft2.png")));
         shootArrowLeft[3] = ImageIO.read((getClass().getResourceAsStream("shootArrowLeft3.png")));
         shootArrowLeft[4] = ImageIO.read((getClass().getResourceAsStream("shootArrowLeft4.png")));
         shootArrowLeft[5] = ImageIO.read((getClass().getResourceAsStream("shootArrowLeft5.png")));
         shootArrowLeft[6] = ImageIO.read((getClass().getResourceAsStream("shootArrowLeft6.png")));
         shootArrowLeft[7] = ImageIO.read((getClass().getResourceAsStream("shootArrowLeft7.png")));
         shootArrowLeft[8] = ImageIO.read((getClass().getResourceAsStream("shootArrowLeft8.png")));
         shootArrowLeft[9] = ImageIO.read((getClass().getResourceAsStream("shootArrowLeft9.png")));
         shootArrowLeft[10] = ImageIO.read((getClass().getResourceAsStream("shootArrowLeft10.png")));
         shootArrowLeft[11] = ImageIO.read((getClass().getResourceAsStream("shootArrowLeft11.png")));
         shootArrowLeft[12] = ImageIO.read((getClass().getResourceAsStream("shootArrowLeft12.png")));
         shootArrowLeft[13] = ImageIO.read((getClass().getResourceAsStream("shootArrowLeft13.png")));
         shootArrowLeft[14] = ImageIO.read((getClass().getResourceAsStream("shootArrowLeft14.png")));
         shootArrowLeft[15] = ImageIO.read((getClass().getResourceAsStream("shootArrowLeft15.png")));
         shootArrowLeft[0] = ImageIO.read((getClass().getResourceAsStream("shootArrowLeft0.png")));
         starBackground = ImageIO.read((getClass().getResourceAsStream("starBackground.png"))); 
         heart = ImageIO.read((getClass().getResourceAsStream("heart.png")));
         arrows = ImageIO.read((getClass().getResourceAsStream("arrows.png")));
         plus5 = ImageIO.read((getClass().getResourceAsStream("plus5Rupee.png")));
         plus10 = ImageIO.read((getClass().getResourceAsStream("plus10Rupee.png")));
         plus20 = ImageIO.read((getClass().getResourceAsStream("plus20Rupee.png")));
         arrowUp = ImageIO.read((getClass().getResourceAsStream("arrowUp.png")));
