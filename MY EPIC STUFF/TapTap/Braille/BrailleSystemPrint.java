import java.util.*;
import java.io.*;
public class BrailleSystemPrint
{
   private static int amountOfStartingLetters = 20;
   ...
   public static void main(String[] args)
   {
      ...
      while(26 - knownLetters.size() != 0)
      {
         ...
         System.out.println("Known Letters  :" + knownLetters);
         System.out.println("Unknown Letters:" + unknownLetters);
         ...
         System.out.println("Characters In Word:   "+tempChars);
         System.out.println("How Computer Sees it: "+tempComputerChars);
         System.out.println("Possible Words:");
         ArrayList<String> wordPossibilities = getWordPossibilities(tempComputerChars);
         System.out.println("Updated Letter Possibilities (if available):");
   ...
   public static void getLetterPossibilities(ArrayList<String> possibleWords, ArrayList<String> computerLetters)
   {
      ...
      {
         ul.setPossibilities();
         System.out.println(ul.identity() + "" + ul.getPossibilities());
      }
   }
